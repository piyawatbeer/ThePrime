 @foreach ($option as $options)
    @endforeach
    <form id="saveForm" method="post" action="/options/addtype/{{ $options->options_id }}" autocomplete="off">
    {{ csrf_field() }}
        ...
        <div class="form-row">
            <div class="form-group  col-sm-12">
                ...
                <div class="input-group-prepend">
                    ...
                    <input type="text" id="otname" name="otname" value="" required class="form-control" autocomplete="off">
                </div>
            </div>
