    ...
    <div class="card mb-3">
        <div class="card-header">
            <div class="text-right">
                <a href="{{ url('categorysub/print') }}" target="blank"  data-modal-name="ajaxModal" role="button"
        ...
        <div class="card-body sailorTableArea">
            <table class="table  display  text-center sailorTable" id="categorysub-table" width="100%"
                cellspacing="0">
