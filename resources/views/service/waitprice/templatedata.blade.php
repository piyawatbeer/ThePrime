...
<div id="app">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="text-right">
                        ...
                        <a href="#" data-href="{{ url('service/templatetype/'.$options->template_id.'') }}"
                            data-modal-name="ajaxModal" role="button" class="btn btn-success btn-create"><i
                                class="fas fa-plus-circle"></i> เพิ่มประเภทงาน
                        </a>

                        <a href="{{ url('service/templatelist/'.$options->template_id.'') }}" role="button"
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="/service/templatedifprint/{{$options->template_id}}"
                                target="blank"><i class="fas fa-print"></i> พิมพ์ใบเปรียบเทียบ</a>
    ...
    <form id="saveForm" method="post" action="/service/templateupdate/{{$options->template_id}}" autocomplete="off">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left" style="background:lightgray;" colspan="2">
                                    ...
                                    <a href="#" class="btn btn-outline-danger btn-sm btn-delete" title="ลบประเภทงาน"
                                        onclick="event.preventDefault();
                                                                    
                                                                   
                                                                    var callback = function () {
                                                                    window.location.replace('{{ url('/service/deltype/'.$templatetypes->templatetype_id.'') }}');
                                                                    }
                                                                confirmBox('ลบข้อมูล {{$templatetypes->totname}}', callback);
                                ...
                                <td class="text-left" colspan="2" style="background:lightgray;">
                                    <div class="input-group-prepend">
                                        ...
                                        <span class="input-group-text"><i class="fas fa-user"></i></span><input
                                            ...
                                            value="{{$templatetypes->tworker}}">
                                    </div>
                                </td>
                                <td class="text-left" colspan="19" style="background:lightgray;"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="23" class="text-left" style="background:paleturquoise;">{{$categorys->categoryname}}
                                </td>
                            </tr>
                           ...
                           @foreach ($typesub as $typesubs)
                            ...
                            <tr>
                                <td>{{++$i}}</td>
                                <td class="text-left">{{$templatelists->tlist}}
                                    <a href="#" class="btn btn-outline-danger btn-sm btn-delete" title="ลบรายการ"
                                        onclick="event.preventDefault();
                                                        
                                                      
                                                        var callback = function () {
                                                        window.location.replace('{{ url('/service/dellist/'.$templatelists->templatelist_id.'') }}');
                                                        }
                                                    confirmBox('ลบข้อมูล {{$templatelists->tlist}}', callback);
                                                        
                                                        "><i class="fa fa-trash"></i></a></td>
                                <input type="hidden" name="templatelist_id[]" id="templatelist_id[]"
                                    value="{{$templatelists->templatelist_id}}">
                                <td class="text-center"><input type="text" onkeypress="isInputNumber(event)"
                                        ...
                                        id="tvalue[]" value="{{$templatelists->tvalue}}"></td>
                                <td><input type="text" name="tfcostl[]" id="tfcostl[]"
                                        class="tfcostl form-control text-center" style="width:90px;"
                                        value="{{$templatelists->tfcostl}}" onkeypress="isInputNumber(event)"></td>
                                ...
                                <td><input type="text" name="tcomment[]" id="tcomment[]"
                                        ...
                                        value="{{$templatelists->tcomment}}"></td>
                                <td class="bg-cream"><input type="text" name="tfcustomerl[]" id="tfcustomerl[]"
                                        ...
                                        value="{{$templatelists->tfcustomerl}}" onkeypress="isInputNumber(event)"></td>
                                ...
                                <td class="bg-cream"><input type="text" name="tfwagel[]" id="tfwagel[]"
                                        ...
                                        value="{{$templatelists->tfwagel}}" onkeypress="isInputNumber(event)"></td>
        ...
        <div class="form-row">
            <div class="form-group col-sm-12 text-center">
                <a href="{{ url('service/waitpriceD/'.$options->service_id) }}" {{-- href="{{ url()->previous() }}"
                    --}}>
