...
<div id="app">
    <ol class="breadcrumb">
        <li class="breadcrumb-item active"><i class="fas fa-folder"></i>
            <span>
                งานที่อยู่ระหว่างรอเสนอราคาก่อสร้าง
            </span></li>
    ...
    <form id="saveForm" method="post" action="/service/pledgeslipsdel/{{$services->service_id}}" autocomplete="off"
        ...
        <div class="card mb-3">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right align-self-center">
                        {{-- @if($template) --}}
                        {{-- @else  --}}
                                                <a href="#" data-href="{{ url('service/templatef/'.$services->service_id.'') }}"
           ...
           <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-grup col-md-6 col-sm-12">
                    <label for="locationc"><b>สถานที่ URL :</b> @if($services->locationc)<a href="{{$services->locationc}}"
                            target="_blank" title="สถานที่">สถานที่ลูกค้า <i
                ...
                <div class="form-group  col-sm-6">
                    <label for="detailc"><b>ใบเสนอราคามัดจำ :</b> @if(!empty($pledges->pledge_id))
                        ...
                        <a href="/service/pledgeprint/{{$services->service_id}}" class="btn btn-outline-primary btn-sm"
                            title="พิมพ์" target="_blank"><i class="fas fa-print"></i></a>
                        @endif
        ...
        <label for="detailc"><b>ใบเสนอราคา :</b>
                                            ...
                                            <?php $i++;?>
                                            <a href="/service/templatedata/{{$templates->template_id}}"
        class="btn btn-outline-primary btn-sm">ใบเสนอราคา {{$i}}</a> 
        ...
        <div id="collapseTwo" style="min-height:100px;" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionExample">
            ...
            <div class="row" style="padding:10px;">
                ...
                <br><a href="{{$designs->design_dropbox}}" style="color:blue;" title="ดูรูปภาพ" target="_blank">ดูรูป Dropbox <i
                        class="fas fa-image   btn-outline-primary btn-sm"></i></a>
                @endif
                <br>
...
<div class="form-row">
    <div class="form-group col-sm-12 text-center">
        <a href="{{ url('service/waitprice/') }}"> <button type="button" class="btn btn-danger" data-dismiss="modal"><i
