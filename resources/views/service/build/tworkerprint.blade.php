...
?>
            ...
            <td>
                ...
                <div class="row">
                    <div class="col text-center">
                        <h3><b>หนังสือสัญญาจ้างเหมาก่อสร้าง</b>
                        </h3>
                        <br>
   ...
   text-justify:inter-cluster; ">
    ...
    text-justify:distribute; text-align:justify; ">
                        &emsp;&emsp;ฝ่ายหนึ่งกับ นาย/นาง/นางสาว ...{{$services->tworker}}... ซึ่งต่อไปสัญญานี้จะเรียกว่า
                        "ผู้รับจ้าง" อีกฝ่ายหนึ่ง ทั้งสองฝ่ายได้ตกลงทำสัญญาจ้างเหมาก่อสร้างกันโดยมีข้อความดังต่อไปนี้
                    </div>
                </div>
                <div class="row">
                    <div class="col" style="font-size:1.3rem; 
        text-justify:distribute; text-align:justify; padding-top:10px;">
                        ...
                        การงานที่ว่าจ้างมีรายละเอียดดังนี้<br><br>
                        <table class="table  display table-bordered  text-center" id="categorysub-table" width="100%"
                            cellspacing="0">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font size="3">{{number_format($templatelists->tmcostp,2)}}</font>
                                    </td>
                                    <td>
                                        <font size="3">{{number_format($templatelists->tmcostptotal,2)}}</font>
                                    </td>
                                    <td>
                                        <font size="3">{{number_format($templatelists->twcostp,2)}}</font>
                                    </td>
                                    <td>
                                        <font size="3">
                                            {{number_format($templatelists->twcostptotal,2)}}<?php //echo number_format($pledges->pledge_total,2);?>
                                        </font>
                                    </td>
                                    <td>
                                        <font size="3">
                                            {{number_format($templatelists->tsumprofit,2)}}<?php //echo number_format($pledges->pledge_total,2);?>
                                        </font>
                                    </td>

                                </tr>
                                <?php $sum=$sum+$templatelists->tsumprofit;?>
                                @endforeach
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <font size="3">{{number_format($sum,2)}}</font>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        text-justify:distribute; text-align:justify; padding-top:10px;">
                        ...
                        &emsp;&emsp;ผู้รับจ้างตกลงรับจ้างก่อสร้างอาคารตามที่กำหนดในสัญญาข้อ 1. โดยสัญญาว่าจะจัดหาสิ่งของ
            ...
            text-justify:distribute; text-align:justify; padding-top:10px;">
                        ...
                        รวมเป็นเงินทั้งสิ้น {{number_format($sum,2)}} บาท
                        ( {{Convert($sum)}} )ตามรายละเอียดในข้อ 1 ของผู้ว่าจ้าง
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    document.title = "หนังสือสัญญาจ้างเหมาก่อสร้าง";
