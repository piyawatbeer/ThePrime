...
<div id="app">
    ...
    <form id="saveForm" method="post" action="/service/templateupdate/{{$options->template_id}}" autocomplete="off">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="tfcostl[]" id="tfcostl[]"
                                        ...
                                        value="{{$templatelists->tfcostl}}" onkeypress="isInputNumber(event)" readonly></td>
                                ...
                                <td class="bg-cream"><input type="text" name="tfcustomerl[]" id="tfcustomerl[]"
                                        ...
                                        value="{{$templatelists->tfcustomerl}}" onkeypress="isInputNumber(event)"readonly></td>
                                ...
                                <td class="bg-cream"><input type="text" name="tfwagel[]" id="tfwagel[]"
                                        ...
                                        value="{{$templatelists->tfwagel}}" onkeypress="isInputNumber(event)" readonly></td>
        ...
        <div class="form-row">
            <div class="form-group col-sm-12 text-center">
                <a href="{{ url('service/buildD/'.$options->service_id) }}" {{-- href="{{ url()->previous() }}" --}}>
