        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="text-right col-md-2">
                    {{-- <a href="" onclick="printpdf('/storage/pdf/survey.pdf');" title="พิมพ์ใบรังวัด" data-modal-name="ajaxModal"
                        role="button" class="btn btn-primary btnprn">
                     --}}
...
<script src="{{ asset('js/pledge.min.js') }}"></script>
<script>
