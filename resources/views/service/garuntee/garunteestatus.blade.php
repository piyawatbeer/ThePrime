...
@endforeach
<form id="saveForm" action="/service/garunteestatusu/{{$services->service_id}}" method="post" autocomplete="off">
    {{ csrf_field() }}
        ...
        <div class="form-group row text-right">
            ...
            <div class="col-sm-8 text-left">
                <div class="input-group-prepend">
                    <input type="radio" name="pledge_status" id="pledge_status" value="รอเสนอราคา" checked>
                    &nbsp;จบงาน
                    &nbsp;
