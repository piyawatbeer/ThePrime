...
<div id="app">
    ...
    <form id="saveForm" method="post" action="/service/addlistboq/{{$templatetypes->template_id}}"
        enctype="multipart/form-data" autocomplete="off">
        {{ csrf_field() }}
        <input type="hidden" name="id" value="{{ $templatetypes->template_id }}">
        <div class="card mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group-prepend">
                                ...
                                <select name="template" id="template" class="form-control col-6" required>
                                    ...
                                    @foreach ($templatetype as $templatetypes)
                                    <option value="{{$templatetypes->templatetype_id}}">
        ...
        <div class="form-row">
            <div class="form-group col-sm-12 text-center">
                <a href="{{ url()->previous() }}"> <button type="button" class="btn btn-danger" data-dismiss="modal"><i
