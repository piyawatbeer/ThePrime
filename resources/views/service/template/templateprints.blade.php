    ...
    <table class="table  display table-bordered  text-center" id="categorysub-table" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <font size="3">{{number_format($templatelists->tmcost,2)}}</font>
                </td>
                <td>
                    <font size="3">{{number_format($templatelists->tmcosttotal,2)}}</font>
                </td>
                <td>
                    <font size="3">{{number_format($templatelists->twcost,2)}}</font>
                </td>
                <td>
                    <font size="3">
                        {{number_format($templatelists->twcosttotal,2)}}<?php //echo number_format($pledges->pledge_total,2);?>
                    </font>
                </td>
                <td>
                    <font size="3">
                        {{number_format(($templatelists->tmcosttotal+$templatelists->twcosttotal),2)}}<?php $sum=$sum+($templatelists->tmcosttotal+$templatelists->twcosttotal) ?>
                    </font>
                </td>
            ...
            <tr>
                ...
                <td>
                    <font size="3"><?php echo number_format($sum,2);?></font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <font size="3"><?php echo number_format(($sum*0.93),2);?></font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <font size="3"><?php echo number_format(($sum*0.07),2);?></font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <font size="3"><b><?php echo number_format($sum,2);?></b></font>
                </td>
            </tr>
        </tbody>
    </table>
...
<script type="text/javascript">
    document.title = "ใบเสนอราคา Prime";
