...
<div id="app">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right align-self-center">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="/service/buildprint/{{$services->service_id}}"
                                target="blank"><i class="fas fa-print"></i> พิมพ์ใบสัญญาจ้าง</a>
                            @endif
                            {{-- <a class="dropdown-item" href="#" target="blank">Link 3</a> --}}
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-grup col-md-6 col-sm-12">
                        ...
                        <label for="emailc"><b>เอกสารการรับประกัน : </b><a
                                href="{{URL::asset('/storage'.$services->garunteepic)}}"
                                class="btn btn-outline-primary btn-sm" title="ดูรูปภาพ" target="_blank">ดูเอกสาร</a>
    ...
    <div class="form-row">
        <div class="form-group col-sm-12 text-center">
            <a href="{{ url('service/endproject/') }}"> <button type="button" class="btn btn-danger"
