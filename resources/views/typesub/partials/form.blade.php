    ...
    <div class="modal-body">
        ...
        <div class="form-row">
            <div class="form-group col-md-4 ">
                <label for="mod">เลขประเภท
                    <span class="text-danger">*</span>
                </label>
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                    <input type="text" id="typesubnumber" name="typesubnumber" value="{{ $data->typesubnumber }}"
            ...
            <div class="form-grup col-md-8 ">
                ...
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                    <input type="text" id="typesubname" name="typesubname" value="{{ $data->typesubname }}"
                        class="form-control" autocomplete="off">
                </div>
            </div>
...
$('#type').empty();
            ...
            $('#category').change(function(){
                ...
                if (category) {
                $.ajax({
                url: '/typesub/categoryfind/' + category,
                type: "GET",
                data: { "_token": "{{ csrf_token() }}" },
                dataType: "json",
                success: function (data) {
                ...
                if (data) {
                    $.each(data, function (key, value) {
                        var str = value.categorynumber;
                        var res = str.toLocaleLowerCase();
                        $('#typesubnumber').val(res);
