...
$(document).ready(function () {
    ...
    var table = $('#options-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL + '/service/datatablesdesign/',
        ...
        columns: [

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    var btnView = '<a href="/service/designD/' + row['service_id'] + '"  title="รายละเอียด">' + code + '</a> ';
                    return btnView;
                },
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/designD/' + row['service_id'] + '"  title="รายละเอียด">' + data + '</a> ';
                    return btnView;
                },
            },
            {
            ...
            },
            {
                ...
                name: 'service_status',
                render: function (data, type, row) {
                    if (row['total'] == 0) { detail = "รอการออกแบบ"; }
                    else {detail = 'ออกแบบ' + row['total'];
                }
                    var btnView = '<a href="/service/designD/' + row['service_id'] + '"  title="รายละเอียด">' + detail + '</a> ';
                    return btnView;
                },
            },
            {
        ...
        columnDefs: [{
            ...
            render: function (data, type, row) {
                ...
                if (row['total'] == 0) { var btnGear = '';}
                else {
                    var btnGear = '<a "#" data-href="designstatus/' + data + '"  data-modal-name="ajaxModal"  class="btn btn-outline-dark btn-sm btn-create" role="button" title="ตั้งค่า"><i class="fas fa-cog"></i></a> ';
                }
