...
$(document).ready(function () {
    ...
    var table = $('#options-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL + '/service/datatablesendproject/',
        ...
        columns: [

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    var btnView = '<a href="/service/endprojectD/' + row['service_id'] + '"  title="รายละเอียด">' + code + '</a> ';
                    return btnView;
                },
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/endprojectD/' + row['service_id'] + '"  title="รายละเอียด">' + data + '</a> ';
                    return btnView;
                },
            },
            {
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/endprojectD/' + row['service_id'] + '"  title="รายละเอียด">' + row['service_status'] + '</a> ';
                    return btnView;
                },
            },
            {
