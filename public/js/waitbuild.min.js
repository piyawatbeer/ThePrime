...
$(document).ready(function () {
    ...
    var table = $('#options-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL + '/service/datatableswaitbuild/',
        ...
        columns: [

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    var btnView = '<a href="/service/waitbuildD/' + row['service_id'] + '"  title="รายละเอียด">' + code + '</a> ';
                    return btnView;
                },
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/waitbuildD/' + row['service_id'] + '"  title="รายละเอียด">' + data + '</a> ';
                    return btnView;
                },
            },
            {
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/waitbuildD/' + row['service_id'] + '"  title="รายละเอียด">' + row['service_status'] + '</a> ';
                    return btnView;
                },
            },
            {
        ...
        columnDefs: [{
            ...
            render: function (data, type, row) {
                ...
                var btnGear = '<a "#" data-href="waitbuildstatus/' + data + '"  data-modal-name="ajaxModal"  class="btn btn-outline-dark btn-sm btn-create" role="button" title="ตั้งค่า"><i class="fas fa-cog"></i></a> ';
