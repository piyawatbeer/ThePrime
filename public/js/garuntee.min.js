...
$(document).ready(function () {
    ...
    var table = $('#options-table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL + '/service/datatablesgaruntee/',
        ...
        columns: [

            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    var btnView = '<a href="/service/garunteeD/' + row['service_id'] + '"  title="รายละเอียด">' + code + '</a> ';
                    return btnView;
                },
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/garunteeD/' + row['service_id'] + '"  title="รายละเอียด">' + data + '</a> ';
                    return btnView;
                },
            },
            {
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/garunteeD/' + row['service_id'] + '"  title="รายละเอียด">' + row['service_status'] + '</a> ';
                    return btnView;
                },
            },
            {
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var btnView = '<a href="/service/garunteeD/' + row['service_id'] + '"  title="รายละเอียด">' + date + '</a> ';
                    return btnView;
                },
            },
            {
